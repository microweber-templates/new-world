    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div class="row">
                    <div class="order-2 order-lg-2 text-center text-sm-center text-lg-start text-lg-left  col-md-10 mx-auto col-lg-6 m-b-20 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="order-1 order-lg-1 text-start text-left text-start text-left text-sm-center text-lg-start col-lg-6 m-b-20">
