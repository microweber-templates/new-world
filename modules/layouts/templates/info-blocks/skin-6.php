...
<section class="section-17 <?php print $layout_classes; ?> fx-particles edit safe-mode nodrop" field="layout-info-blocks-skin-6-<?php print $params['id'] ?>" rel="module">
    <div class="container-fluid">
        <div class="row flexbox-container">
            <div class="col-12 col-lg-6 col-lg-5 img-holder" style="background-image: url('<?php print template_url(); ?>assets/img/img-1.png');"></div>

            <div class="col-12 col-lg-6 col-lg-7 right-side text-center text-lg-start text-lg-left ">
