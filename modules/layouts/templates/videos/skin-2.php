...
<section class="section-6 half-cols <?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-videos-skin-2-<?php print $params['id'] ?>" rel="module">
            ...
            <div class="row">
                <div class="col-12 mx-auto">
                    <div class="row">
                        ...
                        <div class="col-lg-5 info-holder text-start text-left">
