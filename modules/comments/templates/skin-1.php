                                ...
                                <div class="col-12">
                                    ...
                                    <?php else: ?>
                                        <div class="comments-user-profile" style="margin-bottom: 5px;">
                                            ...
                                            <a href="<?php print logout_url('logout'); ?>" class="mw-ui-btn mw-ui-btn-outline mw-ui-btn-small mw-ui-btn-default float-right "><?php _lang("Logout", "templates/new-world"); ?></a>
                                        </div>
                                    <?php endif; ?>
