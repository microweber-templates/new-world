...
<section class="section-10 <?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-videos-skin-4-<?php print $params['id'] ?>" rel="module">
    <div class="container video-left">
        <div class="row ventoux-testimonials-2">
            <div class="col-12 col-lg-6 col-xl-7 left-side m-b-20" style="order: 1;">
                <module type="video" class="video-holder" url="https://vimeo.com/326854751"/>
            </div>

            <div class="col-12 col-lg-6 col-xl-5 right-side" style="order: 2;">
                <div class="testimonial-holder text-left">
                    <div class="info-holder" style="max-width: 100%;">
