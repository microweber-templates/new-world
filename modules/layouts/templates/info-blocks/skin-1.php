    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-10 mx-auto">
                <div class="row">
                    <div class="order-2 order-xl-1 text-center text-sm-center text-lg-start text-lg-left  col-md-10 mx-auto col-lg-6 m-b-20 d-flex flex-column justify-content-center align-items-center">
                        <div class="allow-drop">
                            ...
                            <div class="element m-t-50 text-center text-lg-end text-xl-start">
                                <module type="btn" template="bootstrap" button_style="btn-primary" text="Read More"/>
                            </div>
                        </div>
                    </div>

                    <div class="order-1 order-xl-2 text-start text-start text-sm-center text-xl-start col-lg-6 m-b-20">
