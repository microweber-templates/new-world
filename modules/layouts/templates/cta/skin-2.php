...
<section class="section-27 js-header-transparent <?php print $layout_classes; ?> edit safe-mode nodrop" data-bg-contain data-overlay="1" field="layout-cta-skin-2-<?php print $params['id'] ?>" rel="module">
