...
<section class="section-2 js-header-transparent <?php print $layout_classes; ?> edit" data-overlay="1" field="layout-home-banners-skin-1-<?php print $params['id'] ?>" rel="module">
